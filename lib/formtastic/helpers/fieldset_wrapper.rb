    ...
    module FieldsetWrapper
      ...
      def field_set_and_list_wrapping(*args, &block) #:nodoc:
        ...
        fieldset = template.content_tag(:fieldset,
          Formtastic::Util.html_safe(legend) << template.content_tag(:ol, Formtastic::Util.html_safe(contents), class: 'form'),
      ...
      def field_set_legend(html_options)
        ...
        legend  = template.content_tag(:h5, template.content_tag(:span, Formtastic::Util.html_safe(legend))) unless legend.blank?
        legend
      end
